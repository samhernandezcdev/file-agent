...
def fixed_clock() -> Callable[[], datetime]:
    ...
    Used to prove full-result determinism (including `classified_at`):
    classifying the same DiscoveredFile through two independent classifiers
    that share this clock must yield an identical ClassificationResult.
    """
